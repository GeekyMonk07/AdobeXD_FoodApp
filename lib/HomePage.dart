      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              Pin(size: 40.7, middle: 0.7428),
              Pin(size: 6.4, middle: 0.7297),
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
            ...
            Pinned.fromPins(
              Pin(size: 26.5, middle: 0.2037),
              Pin(size: 20.5, middle: 0.3689),
              child:
                  // Adobe XD layer: 'burger' (group)
                  Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(size: 1.0, middle: 0.8067),
            ...
            Pinned.fromPins(
              Pin(size: 40.0, middle: 0.191),
              Pin(size: 15.0, middle: 0.3952),
              child: Text(
                'Burgers',
                style: TextStyle(
                  fontFamily: 'Poppins',
            ...
            Pinned.fromPins(
              Pin(size: 21.7, middle: 0.5802),
              Pin(size: 23.1, middle: 0.3676),
              child:
                        ...
                        Pinned.fromPins(
                          ...
                          child: Stack(
                            children: <Widget>[
                              ...
                              Pinned.fromPins(
                                Pin(size: 5.5, middle: 0.3701),
                                Pin(size: 5.4, middle: 0.2788),
                                child: SvgPicture.string(
                                  _svg_he90cf,
                                  allowDrawingOutsideViewBox: true,
                                  fit: BoxFit.fill,
                              ...
                              Pinned.fromPins(
                                Pin(size: 4.2, middle: 0.5545),
                                Pin(size: 4.2, middle: 0.5721),
                                child: SvgPicture.string(
                                  _svg_vplg66,
                                  allowDrawingOutsideViewBox: true,
                                  fit: BoxFit.fill,
